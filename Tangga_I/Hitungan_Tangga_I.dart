...
void Hitung_T_I() {
 ...
 // TinggiCanvasG_4 = TinggiT_1.toG_I_d() + 120;
  ...
  TinggiCanvasG_7 = TinggiT_1.toG_I_g() + 100;
...
//data3
  ...
  var AB = Tulangan();
  AB.hitung(MAB/(LebarT/100), fy, fc, TebalPelatTanggaPilih_1*10, d, Selimut);
  print(MAB/(LebarT/100));
  print(fy);
  print(fc);
  print(TebalPelatTanggaPilih_1*10);
  print(d);
  print(Selimut);
  ...
  var LAB = Tulangan();
  LAB.hitung(MLAB/(LebarT/100), fy, fc, TebalPelatTanggaPilih_1*10, d, Selimut);
  ...
  var BA = Tulangan();
  BA.hitung(-MBA/(LebarT/100), fy, fc, TebalPelatTanggaPilih_1*10, d, Selimut);
  Stul_3 = BA.Jarak.toText();
  Dtul_3 = BA.diameterTulangan.toText();
  Syarat_3 = BA.SM;

  var GeserAB = TulanganGeser();
  GeserAB.hitung(SAB, fc, fy, TebalPelatTanggaPilih_1*10, d, ds, Selimut);
