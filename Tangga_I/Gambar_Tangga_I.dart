...
//keterangan MaBA
    final Kete3 = Para(Text:(-MaBA).toStringAsFixed(1) + " kNm",font: font);
    canvas.drawParagraph(Kete3.toKetW(),
...
//keterangan beban FHBA
    final Kete7 = Para(Text:FHbBA.toStringAsFixed(1) + " kN",font: font);
...
//keterangan beban FVBA
    final Kete8 = Para(Text:FVbBA.toStringAsFixed(1) + " kN",font: font);
...
canvas.scale(r.toDouble());
  ...
  canvas.drawParagraph(KeteALP_B.toKetB(),
      Offset((JA-JK+(PanjangT_1)*c).toMirror(M, MV) ,
