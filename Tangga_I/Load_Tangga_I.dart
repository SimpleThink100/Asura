...
class Load_Tangga_IPage extends StatefulWidget {
  final Task task;
  final Projek projek;
  Load_Tangga_IPage({this.projek,this.task,});

  @override
  State<Load_Tangga_IPage> createState() => _Load_Tangga_IPageState();
}

class _Load_Tangga_IPageState extends State<Load_Tangga_IPage> {
