...
class OutputA_Tangga_IPage extends StatefulWidget {

  final Projek projek;
  final Task task;
  OutputA_Tangga_IPage({this.projek,this.task});

  @override
  State<OutputA_Tangga_IPage> createState() => _OutputA_Tangga_IPageState();
}

class _OutputA_Tangga_IPageState extends State<OutputA_Tangga_IPage> {
