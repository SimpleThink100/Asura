...
class OutputD_Tangga_I_1BPage extends StatefulWidget {

  final Projek projek;
  final Task task;
  OutputD_Tangga_I_1BPage({this.projek,this.task});

  @override
  State<OutputD_Tangga_I_1BPage> createState() => _OutputD_Tangga_I_1BPageState();
}

class _OutputD_Tangga_I_1BPageState extends State<OutputD_Tangga_I_1BPage> {
                        ...
                        child: Container(
                          ...
                          child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Text("Tangga"),
                                buildContainerHasil("Panjang Tangga", PanjangT_1.toNaN().toSatuan(_satuan),_satuan,LLayar),
                                buildContainerHasil("Tinggi Tangga", TinggiT_1.toNaN().toSatuan(_satuan), _satuan,LLayar),
                                buildContainerHasil("Tebal Pelat", TebalPelatTanggaPilih_1.toNaN().toSatuan(_satuan),_satuan,LLayar),
                                buildContainerHasil("Lebar Tangga", LebarT.toNaN().toSatuan(_satuan),_satuan,LLayar),
                                ...
                                Text("Bordes"),
                                buildContainerHasil("Panjang Bordes", PanjangB_1.toNaN().toSatuan(_satuan),_satuan,LLayar),
                                ...
                                buildContainerHasil("Tebal Pelat Bordes", TebalPelatBordesPilih_1.toNaN().toSatuan(_satuan),_satuan,LLayar),
                                SizedBox(
                                  height: 5,
                                ),
                              ]),
