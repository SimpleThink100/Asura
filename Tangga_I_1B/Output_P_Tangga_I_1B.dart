...
class OutputP_Tangga_I_1BPage extends StatefulWidget {

  final Projek projek;
  final Task task;
  OutputP_Tangga_I_1BPage({this.projek,this.task});

  @override
  State<OutputP_Tangga_I_1BPage> createState() => _OutputP_Tangga_I_1BPageState();
}

class _OutputP_Tangga_I_1BPageState extends State<OutputP_Tangga_I_1BPage> {
                      ...
                      Container(
                        ...
                        child: Column(
                            ...
                            children: <Widget>[
                              ...
                              buildContainerHasil("Panjang Tangga", PanjangT_1.toNaN(), "cm",LLayar),
                              buildContainerHasil("Tinggi Tangga", TinggiT_1.toNaN(), "cm",LLayar),
                              buildContainerHasil("Lebar Tangga", LebarT.toNaN(), "cm",LLayar),
                              buildContainerHasil("Panjang Bordes", PanjangB_1.toNaN(), "cm",LLayar),
                              buildContainerHasil("Antrade", Antrede_1.toNaN(), "cm",LLayar),
                              buildContainerHasil(
