...
class OutputG_Tangga_I_1BPage extends StatefulWidget {

  final Projek projek;
  final Task task;
  OutputG_Tangga_I_1BPage({this.projek,this.task});

  @override
  State<OutputG_Tangga_I_1BPage> createState() => _OutputG_Tangga_I_1BPageState();
}

class _OutputG_Tangga_I_1BPageState extends State<OutputG_Tangga_I_1BPage> {
