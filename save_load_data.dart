...
class Task {
  ...
  Map<String, dynamic> toMap() {
    ...
    map['tebalT1'] = tebalT1.toString();
    map['tebalT2'] = tebalT2.toString();
    map['tebalT3'] = tebalT3.toString();
    map['tebalB'] = tebalB.toString();
    map['beton'] = Beton.toString();
    map['keramik'] = Keramik.toString();
    map['spesi'] = Spesi.toString();
    map['hand'] = Hand.toString();
    map['hidup'] = hidup.toString();
    map['tkeramik'] = tebalKeramik.toString();
    map['tspesi']= tebalSpesi.toString();
    map['tdinding']=tebalDinding.toString();
    map['fc'] = fc.toString();
    map['fy'] = fy.toString();
    map['D'] = D.toString();
    map['S'] = S.toString();
  ...
  factory Task.fromMap(Map<String, dynamic> map) {
    return Task.id(
      ...
      tebalT1: double.parse(map['tebalT1']),
      tebalT2: double.parse(map['tebalT2']),
      tebalT3: double.parse(map['tebalT3']),
      tebalB: double.parse(map['tebalB']),
      Beton: double.parse(map['beton']),
      Keramik: double.parse(map['keramik']),
      Spesi: double.parse(map['spesi']),
      Hand: double.parse(map['hand']),
      hidup: double.parse(map['hidup']),
      tebalKeramik:double.parse(map['tkeramik']),
      tebalSpesi:double.parse( map['tspesi']),
      tebalDinding:double.parse(map['tdinding']),
