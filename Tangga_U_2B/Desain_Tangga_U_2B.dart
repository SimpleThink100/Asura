...
//ceking
  void Work() {
    ...
    controllerPanjangT3.text = "320";
    controllerTinggiT3.text = "200";
    controllerOptrade3.text = "18";
              ...
              children: <Widget>[
                ...
                Visibility(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('Tangga Atas'),
                      buildContainerTextFiel('Panjang Tangga Atas', 'cm', controllerPanjangT3),
                      buildContainerTextFiel('Tinggi Tangga Atas', 'cm', controllerTinggiT3),
                      buildContainerTextFiel('optrede Atas', 'cm', controllerOptrade3),
                      Text('Tangga Tengah'),
                      buildContainerTextFiel('Panjang Tangga Tengah', 'cm', controllerPanjangT2),
                      buildContainerTextFiel('Tinggi Tangga Tengah', 'cm', controllerTinggiT2),
                      buildContainerTextFiel('optrede Tengah', 'cm', controllerOptrade2),
                      Text('Tangga Bawah'),
                        ...
                        child: Container(
                          ...
                          child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Text('Tangga Atas'),
                                buildContainerHasil(
                                    "Antrade", Antrede_3.toNaN(), "cm"),
                                buildContainerHasil(
                                    "Antrade Total", AntredeNT_3.toNaN(), "buah"),
                                buildContainerHasil(
                                    "Antrade Biasa", AntredeN_3.toNaN(), "buah"),
                                buildContainerHasil(
                                    "Antrade + 1cm ", AntredeN1_3.toNaN(), "buah"),
                                buildContainerHasil(
                                    "Antrade - 1cm", Antrede1N_3.toNaN(), "buah"),
                                buildContainerHasil(
                                    "Optrade", Optrede_3.toNaN(), "cm"),
                                buildContainerHasil(
                                    "Optrade Total", OptredeNT_3.toNaN(), "buah"),
                                buildContainerHasil(
                                    "Optrade Biasa", OptredeN_3.toNaN(), "buah"),
                                buildContainerHasil(
                                    "Optrade + 1cm", OptredeN1_3.toNaN(), "buah"),
                                buildContainerHasil(
                                    "Optrade - 1cm", Optrede1N_3.toNaN(), "buah"),
                                buildContainerHasil("Sudut", Sudut_3.toNaN(), "°"),
                                SizedBox(
                                  height: 5,
                                ),
                                Text('Tangga Tengah'),
