...
void Hitung_T_U_2B_3() {
  ...
  AntredeNT_3 = teratas=='Antrede'?OptredeNT_3:OptredeNT_3-1;
  ...
  switch (settingPembagiAntrede) {
    ...
    case "1 cm":
      ...
      if (AntredeS_3 < 0) {
        ...
        AntredeNB_3 = (Antrede1N_3 / 2).toRound(0).abs();
        AntredeNA_3 = (Antrede1N_3 / 2 - 0.2).toRound(0).abs();
      } else {
        AntredeN1_3 = AntredeS_3 / PembagiAntrede;
        AntredeNB_3 = (AntredeN1_3 / 2).toRound(0).abs();
        AntredeNA_3 = (AntredeN1_3 / 2 - 0.2).toRound(0).abs();
      }
      ;
  ...
  switch (settingPembagiOptrede) {
    ...
    case "1 cm":
      ...
      if (OptredeS_3 < 0) {
        ...
        OptredeNB_3 = (Optrede1N_3 / 2).toRound(0).abs();
        OptredeNA_3 = (Optrede1N_3 / 2 - 0.2).toRound(0).abs();
      } else {
        OptredeN1_3 = OptredeS_3 / PembagiOptrede;
        OptredeNB_3 = (OptredeN1_3 / 2).toRound(0).abs();
        OptredeNA_3 = (OptredeN1_3 / 2 - 0.2).toRound(0).abs();
      }
...
void Hitung_T_U_2B() {
  ...
  TinggiCanvasm_1 =  (TinggiT_3).toM_U_2B_a() + 120;
  TinggiCanvasm_2 = (TinggiT_2).toM_U_2B_b() + 120;
  TinggiCanvasm_3 = (TinggiT_1).toM_U_2B_c() + 120;

  //analisis
  TinggiCanvasG_1 = (TinggiT_1 + TinggiT_2 + TinggiT_3).toG_U_2B_aa() + 120;
  //atas
  TinggiCanvasG_2 = (Optrede_3*2).toG_U_2B_b()+190;
  TinggiCanvasG_3 = TinggiT_3.toG_U_2B_c()+140;
  //TinggiCanvasG_4 = TinggiT_1.toG_U_2B_c()+160;
  TinggiCanvasG_5 = TinggiT_3.toG_U_2B_e()+100;
  TinggiCanvasG_6 = TinggiT_3.toG_U_2B_f()+100;
  TinggiCanvasG_7 = TinggiT_3.toG_U_2B_g()+100;
  //tengah
  TinggiCanvasG_8 = (Optrede_2*2).toG_U_2B_h()+190;
  TinggiCanvasG_9 = TinggiT_2.toG_U_2B_i()+140;
  //TinggiCanvasG_10 = TinggiT_1.toG_U_2B_c()+160;
  TinggiCanvasG_11 = TinggiT_2.toG_U_2B_k()+110;
  TinggiCanvasG_12 = TinggiT_2.toG_U_2B_l()+110;
  TinggiCanvasG_13 = TinggiT_2.toG_U_2B_m()+110;
 //bawah
  TinggiCanvasG_14 = (Optrede_1).toG_U_2B_n()+190;
  TinggiCanvasG_15 = TinggiT_1.toG_U_2B_o()+140;
  //TinggiCanvasG_16 = TinggiT_1.toG_U_2B_c()+160;
  TinggiCanvasG_17 = TinggiT_1.toG_U_2B_q()+100;
  TinggiCanvasG_18 = TinggiT_1.toG_U_2B_r()+100;
  TinggiCanvasG_19 = TinggiT_1.toG_U_2B_s()+100;

  TinggiCanvasD_1 = TinggiT_3.toD_U_2B_a()+180;
  TinggiCanvasD_2 = (hB).toD_U_2B_b()+160;
  TinggiCanvasD_3 = TinggiT_2.toD_U_2B_c()+200;
  ...
  TinggiCanvasP = (TinggiT_1 + TinggiT_2 + TinggiT_3).toT_U_2B_a() + 80;
}

void HitungT_T_U_2B_3(){
    //HITUNGAN 1
    //Hitungan 2
    PanjangTanggaMiring_3 = sqrt(pow(PanjangT_3 / 100, 2) + pow(TinggiT_3 / 100, 2));
    ...
    TinggiMiringTangga_3 = TinggiMiring5AnakTangga_3 + TebalPelatTanggaPilih_3 ;
    //beban
    BeratSendiriTangga_3 = TinggiMiringTangga_3 / 100 * beton*(LebarT/100);
    BeratKeramikTangga_3 = keramik *tkeramik/100*(LebarT/100);
    BeratSpesiTangga_3 = spesi * tspesi/100*(LebarT/100);
    BeratHandrailTangga_3 = ralling ;
    BebanMatiTangga_3 = BeratSendiriTangga_3 +
        BeratKeramikTangga_3 +
        BeratSpesiTangga_3 +
        BeratHandrailTangga_3;
    BebanHidupTangga_3 = hidup*(LebarT/100);
    ...
    BeratKeramikBordes_3 = keramik * tkeramik/100*(LebarT/100);
    BeratSpesiBordes_3 = spesi * tspesi/100*(LebarT/100);
    BeratHandrailBordes_3 = ralling ;
    BebanHidupBordes_3 = hidup*(LebarT/100);
...
//data3
  ...
  final double A_T=(TebalPelatTanggaPilih_3*1000.0)/pow(10.0,6);
  final double I_T=(1/12*1000.0*pow(TebalPelatTanggaPilih_3,3))/pow(10.0,12);
  final double A_Ba=(TebalPelatBordesPilih_2*1000.0)/pow(10.0,6);
  final double I_Ba=(1/12*1000.0*pow(TebalPelatBordesPilih_2,3))/pow(10.0,12);
  final x = matrik();
  x.Hitung2(
    //A_1:0.05,A_2:0.05,
...
//data7
    ...
    var DE = Tulangan();
    DE.hitung(
        MDE/(LebarT/100), fy, fc, TebalPelatBordesPilih_3*10, d, Selimut);
  ...
  var ED = Tulangan();
    ED.hitung(
        MED/(LebarT/100), fy, fc, TebalPelatBordesPilih_3*10, d, Selimut);
    Stul_5=ED.Jarak.toText();
    Dtul_5=ED.diameterTulangan.toText();
    Syarat_5=ED.SM;

    var GDE = TulanganGeser();
    GDE.hitung(max(SED,SDE), fc, fy, TebalPelatTanggaPilih_3*10, d, ds, Selimut);
    ...
    var EF = Tulangan();
    EF.hitung(
        MEF/(LebarT/100), fy, fc, TebalPelatTanggaPilih_3*10, d, Selimut);
    ...
    var FE = Tulangan();
    FE.hitung(
        -MFE/(LebarT/100), fy, fc, TebalPelatTanggaPilih_3*10, d, Selimut);
    ...
    var LEF = Tulangan();
    LEF.hitung(
        -MLEF/(LebarT/100), fy, fc, TebalPelatTanggaPilih_3*10, d, Selimut);
    ...
    GEF.hitung(max(SEF,SFE), fc, fy, TebalPelatTanggaPilih_3*10, d, ds, Selimut);
  ...
  var B = BalokBordes();
  B.hitung(hB*10, bB*10, fyB, fcB, selimutB, dB, dsB,1/12*wup_2*pow(LebarB_1/100,2),);
  Stul_1=B.N.toText();
  Dtul_1=B.D.toText();
  Syarat_1=B.SM;
  NBTa_3=B.N;
  ...
  var BL = BalokBordes();
  BL.hitung(hB*10, bB*10, fyB, fcB, selimutB, dB, dsB,1/24*wup_2*pow(LebarB_1/100,2),);
  Stul_2=BL.N.toText();
  Dtul_2=BL.D.toText();
  Syarat_2=BL.SM;
  NBLa_3=BL.N;
  ...
  GB.hitung(hB*10, bB*10, fyB, fcB, selimutB, dB, dsB,wup_2*LebarB_1/100/2,);
...
//data3
  ...
  // Hitungan 3
  final double E=1.0*pow(10.0,6);
  final double A_T=(TebalPelatTanggaPilih_2*1000.0)/pow(10.0,6);
  final double I_T=(1/12*1000.0*pow(TebalPelatTanggaPilih_2,3))/pow(10.0,12);
  final double A_Ba=(TebalPelatBordesPilih_1*1000.0)/pow(10.0,6);
  final double I_Ba=(1/12*1000.0*pow(TebalPelatBordesPilih_1,3))/pow(10.0,12);
  final double A_Bb=(TebalPelatBordesPilih_2*1000.0)/pow(10.0,6);
  final double I_Bb=(1/12*1000.0*pow(TebalPelatBordesPilih_2,3))/pow(10.0,12);
  final x = matrik();
  x.Hitung3(
...
//pembebanan balok1
  ...
  BBeratBalok_2=hB/100*bB/100*beton;
  BBeratDinding_2 = 2*dinding;
  BBeratPelat_2 = TebalPelatBordesPilih_1/100*beton*PanjangB_2/100;
  BBeratAdukanPelat_2 = spesi*tspesi/100*PanjangB_2/100;
  BBeratKeramikPelat_2 = keramik*tkeramik/100*PanjangB_2/100;
  BBeratHandPelat_2 =ralling;
  wdbp_2 = BBeratBalok_2+BBeratDinding_2+BBeratPelat_2+
...
void HitungT_T_U_2B(){
  ...
  PdfData6 = Data6.map((e) => [e.BarisKe, e.nama, e.rumus, e.tanda, e.hasil, e.satuan,]).toList();
  PdfData7 = Data7.map((e) => [e.BarisKe, e.nama, e.rumus, e.tanda, e.hasil, e.satuan,]).toList();
  PdfData8 = Data8.map((e) => [e.BarisKe, e.nama, e.rumus, e.tanda, e.hasil, e.satuan,]).toList();
  PdfData9 = Data9.map((e) => [e.BarisKe, e.nama, e.rumus, e.tanda, e.hasil, e.satuan,]).toList();
}
