...
class OutputG_Tangga_U_2BPage extends StatefulWidget {

  final Projek projek;
  final Task task;
  OutputG_Tangga_U_2BPage({this.projek,this.task});

  @override
  State<OutputG_Tangga_U_2BPage> createState() => _OutputG_Tangga_U_2BPageState();
}

class _OutputG_Tangga_U_2BPageState extends State<OutputG_Tangga_U_2BPage> {
              ...
              children: <Widget>[
                ...
                Visibility(
                  ...
                  child: Container(
                      ...
                      //color: Colors.green[500],
                      child: CustomPaint(
                        size: Size(LebarCanvas, TinggiCanvasD_4),
                        painter: Gambar_Tangga_U_2B_4D(),
                      )),
                ),
                //tombol 11
                Container(
                      ...
                      InkWell(
                        child: Container(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text('Penulangan Balok Atas',style: TextStyle(fontSize: 20,color: Colors.white),),
                ...
                Visibility(
                  ...
                  child: Container(
                      ...
                      //color: Colors.green[500],
                      child: CustomPaint(
                        size: Size(LebarCanvas, TinggiCanvasD_6),
                        painter: Gambar_Tangga_U_2B_6D(),
                      )),
                ),
                //tombol 15
                Container(
                ...
                Visibility(
                  ...
                  child: Container(
                      ...
                      //color: Colors.green[500],
                      child: CustomPaint(
                        size: Size(LebarCanvas, TinggiCanvasD_7),
                        painter: Gambar_Tangga_U_2B_7D(),
                      )),
                ),
