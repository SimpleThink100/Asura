...
class OutputA_Tangga_U_2BPage extends StatefulWidget {

  final Projek projek;
  final Task task;
  OutputA_Tangga_U_2BPage({this.projek,this.task});

  @override
  State<OutputA_Tangga_U_2BPage> createState() => _OutputA_Tangga_U_2BPageState();
}

class _OutputA_Tangga_U_2BPageState extends State<OutputA_Tangga_U_2BPage> {
      ...
      body: Container(
          ...
          child: ListView(
              children: <Widget>[
                      ...
                      InkWell(
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text('Tangga Tampak Samping',style: TextStyle(fontSize: 20,color: Colors.white),),
                ...
                //             mainAxisAlignment: MainAxisAlignment.spaceBetween,
                //             children: [
                //               Text('Tangga Tampak Depan',style: TextStyle(fontSize: 20,color: Colors.white),),
                //               Gambar1b==false?Icon1:Icon2,
                //             ],
                //           ),
                //         ),
                //         onTap: (){
                ...
                //         painter: Gambar_Tangga_U_2B_1bO(),
                //       )),
                // ),
                Text('Tangga Atas'),
                //tombol 2
                      ...
                      InkWell(
                        child: Container(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text('Tebal Tangga',style: TextStyle(fontSize: 20,color: Colors.white),),
                ...
                Visibility(
                  ...
                  child: Container(
                      ...
                      child: CustomPaint(
                        ...
                        painter: Gambar_Tangga_U_2B_11O(),
                      )),
                ),
                //tombol 12
                Container(
                ...
                Visibility(
                  ...
                  child: Container(
                      ...
                      child: CustomPaint(
                        ...
                        painter: Gambar_Tangga_U_2B_12O(),
                      )),
                ),
                //tombol 13
                Container(
                ...
                Visibility(
                  ...
                  child: Container(
                      ...
                      child: CustomPaint(
                        ...
                        painter: Gambar_Tangga_U_2B_13O(),
                      )),
                ),
                Text('Tangga Bawah'),
                //tombol 14
                      ...
                      InkWell(
                        child: Container(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text('Tebal Anak Tangga',style: TextStyle(fontSize: 20,color: Colors.white),),
                              Gambar14==false?Icon1:Icon2,
                            ],
                          ),
                        ),
                        onTap: (){
                ...
                Visibility(
                  ...
                  child: Container(
                      ...
                      //color: Colors.green[500],
                      child: CustomPaint(
                        size: Size(LebarCanvas, TinggiCanvasG_14),
                        painter: Gambar_Tangga_U_2B_14O(),
                      )),
                ),
                //tombol 15
                Container(
                ...
                Visibility(
                  ...
                  child: Container(
                      ...
                      //color: Colors.green[500],
                      child: CustomPaint(
                        size: Size(LebarCanvas, TinggiCanvasG_15),
                        painter: Gambar_Tangga_U_2B_15O(),
                      )),
                ),
                //tombol 17
                Container(
                ...
                Visibility(
                  ...
                  child: Container(
                      ...
                      //color: Colors.green[500],
                      child: CustomPaint(
                        size: Size(LebarCanvas, TinggiCanvasG_17),
                        painter: Gambar_Tangga_U_2B_17O(),
                      )),
                ),
                //tombol 18
                Container(
                ...
                Visibility(
                  ...
                  child: Container(
                      ...
                      //color: Colors.green[500],
                      child: CustomPaint(
                        size: Size(LebarCanvas, TinggiCanvasG_18),
                        painter: Gambar_Tangga_U_2B_18O(),
                      )),
                ),
                //tombol 19
                Container(
                ...
                Visibility(
                  ...
                  child: Container(
                      ...
                      //color: Colors.green[500],
                      child: CustomPaint(
                        size: Size(LebarCanvas, TinggiCanvasG_19),
                        painter: Gambar_Tangga_U_2B_19O(),
                      )),
                ),
              ])),
    );}
