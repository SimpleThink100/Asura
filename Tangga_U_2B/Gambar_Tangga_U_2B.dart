...
void generatePdfGambar1() async {
  final recorder = ui.PictureRecorder();
  final canvas =
  Canvas(recorder, Rect.fromPoints(Offset(0.0, 0.0), Offset(300, 200)));
  //judulgambar
  final double c = (1.0).toT_U_2B_a();
  final Judul = Para(Text: "Tampak Samping",Lebar:LebarCanvas);
  canvas.drawParagraph(Judul.toJudul(), Offset(0, 20));
...
final Kete12 = Para(Text: TinggiT_1.toStringAsFixed(0) + " cm",Lebar: TinggiT_1*c,Posisi: TextAlign.center);
  canvas.drawParagraph(Kete12.toKetW(),
      Offset(JA + PanjangT_1*c + 20,
          TinggiCanvasa - JB - TinggiT_1*c / 2 - 5));
  //keterangan13
  ...
  canvas.drawPath(path, Line5);

  canvas.drawLine(Offset((JA).toMirror(M, MV), TinggiCanvasa - JB + JK),
      Offset((JA + PanjangT_1*c).toMirror(M, MV), TinggiCanvasa - JB + JK), Line5);
//garis keterangan kanan
  canvas.drawLine(
      Offset(JA + PanjangT_1*c + JK, TinggiCanvasa - JB),
      Offset(JA + PanjangT_1*c + JK, TinggiCanvasa - JB - TinggiT_1*c),
      Line3);
...
void generatePdfGambar2() async {
  final recorder = ui.PictureRecorder();
  final canvas =
  Canvas(recorder, Rect.fromPoints(Offset(0.0, 0.0), Offset(500, 200)));
...
class Gambar_Tangga_U_2B_11O extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(
        ...
        Line9);
    // keterangan NGH
    final Kete7 = Para(Text:(-NGH).toStringAsFixed(1) + " kN/m",font: font);
    canvas.drawParagraph(Kete7.toKetW(),
        Offset((JA-JK*4+(-PanjangB_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-NGH*s)*c));
// keterangan NHG
    final Kete8 = Para(Text:(NHG).toStringAsFixed(1) + " kN/m",font: font);
...
// keterangan NHI
    final Kete4 = Para(Text:(-NHI).toStringAsFixed(1) + " kN/m",font: font);
    canvas.drawParagraph(Kete4.toKetW(),
        Offset((JA-JK*3+(-NAB*s*cs)*c).toMirror(M, MV),
            TinggiCanvasa - JB-JK*2+(-NAB*cc*s)*c));
// keterangan NIH
    final Kete1 = Para(Text:(NIH).toStringAsFixed(1) + " kN/m",font: font);
    canvas.drawParagraph(Kete1.toKetW(),
        Offset((JA-JK*4+(PanjangT_1)*c).toMirror(M, MV),
    ...
    canvas.drawLine(
        ...
        Line9);
    // keterangan NIJ
    final Kete5 = Para(Text:(-NIJ).toStringAsFixed(1) + " kN/m",font: font);
    canvas.drawParagraph(Kete5.toKetW(),
        Offset((JA-JK*4+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+JK+(-TinggiT_1-NIJ*s)*c));
// keterangan NJI
    final Kete6 = Para(Text:(NJI).toStringAsFixed(1) + " kN/m",font: font);
    canvas.drawParagraph(Kete6.toKetW(),
...
class Gambar_Tangga_U_2B_12O extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(
        ...
        Line9);
    // keterangan NGH
    final Kete7 = Para(Text:(SGH).toStringAsFixed(1) + " kN/m",font: font);
    canvas.drawParagraph(Kete7.toKetW(),
        Offset((JA-JK*4+(-PanjangB_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB-JK*2+(-SBC*s)*c));
// keterangan NHG
    final Kete8 = Para(Text:(-SHG).toStringAsFixed(1) + " kN/m",font: font);
    canvas.drawParagraph(Kete8.toKetW(),
...
// keterangan SHI
    final Kete4 = Para(Text:(SHI).toStringAsFixed(1) + " kN/m",font:font);
    canvas.drawParagraph(Kete4.toKetW(),
        Offset((JA-JK*2+(-SHI*4*cs)*c).toMirror(M, MV),
            TinggiCanvasa - JB-JK*4+(-SHI*cc*4)*c));
// keterangan SIH
    final Kete1 = Para(Text:(SIH).toStringAsFixed(1) + " kN/m",font:font);
    canvas.drawParagraph(Kete1.toKetW(),
    ...
    canvas.drawLine(
        ...
        Line9);
    // keterangan NIJ
    final Kete5 = Para(Text:(-SIJ).toStringAsFixed(1) + " kN/m",font: font);
    canvas.drawParagraph(Kete5.toKetW(),
        Offset((JA-JK*7+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB-JK*2+(-TinggiT_1+SIJ*s)*c));
// keterangan NJI
    final Kete6 = Para(Text:(SJI).toStringAsFixed(1) + " kN/m",font: font);
    canvas.drawParagraph(Kete6.toKetW(),
        Offset((JA-JK*3+(PanjangT_1+PanjangB_1)*c).toMirror(M, MV),
...
class Gambar_Tangga_U_2B_13O extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(
        ...
        Line9);
    // keterangan MGH
    final Kete7 = Para(Text:(MGH).toStringAsFixed(1) + " kN/m",font: font);
    canvas.drawParagraph(Kete7.toKetW(),
        Offset((JA-JK*4+(-PanjangB_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB-JK*2+(-SBC*s)*c));
// keterangan MHG
    final Kete8 = Para(Text:(MHG).toStringAsFixed(1) + " kN/m",font: font);
    canvas.drawParagraph(Kete8.toKetW(),
        Offset((JA-JK*3+(0.0)*c).toMirror(M, MV),
...
// keterangan MLAB
    final Kete2 = Para(Text:(-MLHI).toStringAsFixed(1) + " kN/m",font: font);
    canvas.drawParagraph(Kete2.toKetW(),
    ...
    canvas.drawLine(
        ...
        Line9);
    // keterangan MIJ
    final Kete5 = Para(Text:(MIJ).toStringAsFixed(1) + " kN/m",font: font);
    canvas.drawParagraph(Kete5.toKetW(),
        Offset((JA-JK*3+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB-JK*4+(-TinggiT_1-MIJ*s)*c));
// keterangan MCB
    final Kete6 = Para(Text:(-MJI).toStringAsFixed(1) + " kN/m",font: font);
    canvas.drawParagraph(Kete6.toKetW(),
        Offset((JA-JK*3+(PanjangT_1+PanjangB_1)*c).toMirror(M, MV),
...
//garis bawah
    ...
    canvas.drawLine(
        ...
        Line11);
    canvas.drawLine(
        Offset(JA + (Selimut/10)*c, TinggiCanvasa - JB+(Optrede_3-Selimut/10)*c),
        Offset(JA + (PanjangT_3-Selimut/10)*c,
...
class Gambar_Tangga_U_2B_3D extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    //judulgambar
    final Judul11 = Para(Text: "Tangga Tengah",Lebar: LebarCanvas);
    canvas.drawParagraph(Judul11.toJudul(), Offset(0, 20));
    //keterangan18 panjang bordes
