...
class Gambar_Tangga_U_1B_1 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final double xT_2=TebalPelatTanggaPilih_2/sina_2-(TebalPelatBordesPilih_1)*cosa_2/sina_2;
    final double yT_2=TebalPelatTanggaPilih_2*cosa_2;
    final double yB_2=TebalPelatBordesPilih_2;
    final double JA=20<(PanjangT_2-PanjangT_1)*c?(PanjangT_2-PanjangT_1+Antrede_2*(1-_teratas))*c:20+(Antrede_2*(1-_teratas))*c;
    ...
    path.lineTo((JA +(PanjangT_1+LebarB_1)*c).toMirror(M, MV),
    ...
    path.lineTo((JA + (xT_1)*c).toMirror(M, MV), TinggiCanvasa - JB);
    ...
    canvas.drawLine(
        ...
        Offset((JA + (PanjangT_1+LebarB_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1)*c), Line1);
    canvas.drawLine(
        Offset((JA+(PanjangT_1+LebarB_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1)*c),
        Offset((JA + (PanjangT_1+LebarB_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1+yB_1)*c), Line1);
    canvas.drawLine(
        Offset((JA+(PanjangT_1+LebarB_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1+yB_1)*c),
    ...
    path1.lineTo((JA +(PanjangT_1-PanjangT_2+Antrede_2*(_teratas-1))*c).toMirror(M, MV),
        TinggiCanvasa - JB +(-TinggiT_1-TinggiT_2+yT_2)*c);
    path1.lineTo((JA +(PanjangT_1-xT_2)*c).toMirror(M, MV),
        TinggiCanvasa - JB +(-TinggiT_1+yB_1)*c);
    path1.lineTo((JA +(PanjangT_1+LebarB_1)*c).toMirror(M, MV),
        TinggiCanvasa - JB +(-TinggiT_1+yB_1)*c);
    path1.lineTo((JA +(PanjangT_1+LebarB_1)*c).toMirror(M, MV),
        TinggiCanvasa - JB +(-TinggiT_1)*c);
    ...
    canvas.drawLine(
        Offset((JA+(PanjangT_1-PanjangT_2+Antrede_2*(_teratas-1))*c).toMirror(M, MV),
    ...
    canvas.drawLine(
        Offset((JA+(PanjangT_1-PanjangT_2+Antrede_2*(_teratas-1))*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1-TinggiT_2+yT_2)*c),
        Offset((JA+(PanjangT_1-xT_2)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1+yB_1)*c),
        Line1);
    canvas.drawLine(
        Offset((JA+(PanjangT_1-xT_2)*c).toMirror(M, MV),
    ...
    //balok
    var path4 =Path();
    path4.moveTo((JA +(PanjangT_1+LebarB_1+bB/2)*c).toMirror(M, MV),
        TinggiCanvasa - JB +(-TinggiT_1)*c);
    path4.lineTo((JA +(PanjangT_1+LebarB_1+bB/2)*c).toMirror(M, MV),
    ...
    canvas.drawLine(
        Offset((JA+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB-TinggiT_1*c),
        Offset((JA+(PanjangT_1+LebarB_1+bB/2)*c).toMirror(M, MV),
            TinggiCanvasa - JB-TinggiT_1*c), Line1);
    canvas.drawLine(
        Offset((JA+(PanjangT_1+LebarB_1+bB/2)*c).toMirror(M, MV),
            TinggiCanvasa - JB-TinggiT_1*c),
        Offset((JA+(PanjangT_1+LebarB_1+bB/2)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1+hB)*c), Line1);
    canvas.drawLine(
        Offset((JA+(PanjangT_1+LebarB_1+bB/2)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1+hB)*c),
        Offset((JA+(PanjangT_1+LebarB_1-bB/2)*c).toMirror(M, MV),
    ...
    canvas.drawLine(
        Offset(JA + (PanjangT_1+LebarB_1+bB/2)*c + JK, TinggiCanvasa - JB),
        Offset(JA + (PanjangT_1+LebarB_1+bB/2)*c + JK, TinggiCanvasa - JB - TinggiT_1*c),
        Line1);
    canvas.drawLine(
        Offset(JA + (PanjangT_1+LebarB_1+bB/2)*c + JK+5, TinggiCanvasa - JB - TinggiT_1*c),
        Offset(JA + (PanjangT_1+LebarB_1+bB/2)*c + JK-5, TinggiCanvasa - JB - TinggiT_1*c),
        Line1);
    canvas.drawLine(
        Offset(JA + (PanjangT_1+LebarB_1+bB/2)*c + JK, TinggiCanvasa - JB - TinggiT_1*c),
        Offset(JA + (PanjangT_1+LebarB_1+bB/2)*c + JK, TinggiCanvasa - JB - (TinggiT_1+TinggiT_2)*c),
        Line1);
    //vertikal
    ...
    canvas.drawParagraph(Kete12.toKetW(),
        Offset( -TinggiCanvasa + JB + (0.0)*c,JA + (PanjangT_1+LebarB_1+bB/2)*c+JK,));
    //keterangan 14
    ...
    canvas.drawParagraph(Kete14.toKetW(),
        Offset(-TinggiCanvasa + JB + (TinggiT_1)*c,JA + (PanjangT_1+LebarB_1+bB/2)*c+JK));
...
class Gambar_Tangga_U_1B_2 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var i = 0; i <= OptredeNT_2-1; i++) {
      canvas.drawLine(
          Offset(JA+(Antrede_2*(i))*c,TinggiCanvasb - JB ),
          Offset(JA+(Antrede_2*(i))*c,TinggiCanvasb - JB+(-LebarT)*c),
          Line1);
    }
    for (var i = 0; i <= OptredeNT_1-1; i++) {
      canvas.drawLine(
          Offset(JA+(PanjangT_2-PanjangT_1+Antrede_1*(i))*c,
...
//tangga
    ...
    canvas.drawLine(
        Offset((JA+(0.0)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_2)*c),
        Offset((JA+(NFE*s*sina_2)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_2-NFE*cosa_2*s)*c),
        Line9);
    canvas.drawLine(
        Offset((JA+(PanjangT_2)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(0.0)*c),
        Offset((JA+(PanjangT_2-NEF*s*sina_2)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(NEF*s*cosa_2)*c),
        Line9);
    canvas.drawLine(
        Offset((JA+(NFE*s*sina_2)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_2-NFE*cosa_2*s)*c),
...
//tangga
    ...
    canvas.drawLine(
        Offset((JA+(0.0)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_2)*c),
        Offset((JA+(SFE*s*sina_2)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_2-SFE*cosa_2*s)*c),
        Line9);
    canvas.drawLine(
        Offset((JA+(PanjangT_2)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(0.0)*c),
        Offset((JA+(PanjangT_2-SEF*s*sina_2)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(SEF*s*cosa_2)*c),
        Line9);
    canvas.drawLine(
        Offset((JA+(SFE*s*sina_2)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_2-SFE*cosa_2*s)*c),
...
class Gambar_Tangga_U_1B_7O extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(
        Offset((JA+(0.0)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_2)*c),
        Offset((JA+(MAB*s*sina_2)*c).toMirror(M, MV),//cs
            TinggiCanvasa - JB+(-TinggiT_2-MAB*cosa_2*s)*c),//cc
        Line9);
    canvas.drawLine(
        Offset((JA+(PanjangT_2)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(0.0)*c),
        Offset((JA+(PanjangT_2-MBA*s*sina_2)*c).toMirror(M, MV),//cs
            TinggiCanvasa - JB+(0.0+MBA*cosa_2*s)*c),//cc
        Line9);

    var arc = Path();
    arc.moveTo(
      //kiri
        (JA+(-MFE*s*sina_2)*c).toMirror(M, MV),
        TinggiCanvasa - JB+(-TinggiT_2+MFE*cosa_2*s)*c);
    arc.quadraticBezierTo(
      //tengah
        (JA+(PanjangT_2-JFE*100*cosa_2+(MLEF-MEF)*s*sina_2)*c).toMirror(M, MV),
        TinggiCanvasa - JB-(-TinggiT_2+JFE*100*sina_2-(MLEF-MEF)*s*cosa_2)*c,
        //kanan
        (JA+(PanjangT_2+MEF*s*sina_2)*c).toMirror(M, MV),
        TinggiCanvasa - JB+(-MEF*s*cosa_2)*c);
...
// keterangan MEF
    ...
    canvas.drawParagraph(Kete1.toKetW(),
        Offset((JA+(PanjangT_2+MEF*4*cs)*c).toMirror(M, MV),
            TinggiCanvasa - JB-JK*3+(0.0)*c));
// keterangan MLEF
    final Kete2 = Para(Text:(-MLEF).toStringAsFixed(1) + " kNm",font: font);
    canvas.drawParagraph(Kete2.toKetW(),
        Offset( (JA+(-JFE*cosa_2-(MLEF-MFE)*2*sina_2)*c).toMirror(M, MV),
          TinggiCanvasa - JB+(JFE*sina_2-(MLEF-MFE)*2*cosa_2)*c,));
...
// keterangan MDE
    ...
    canvas.drawParagraph(Kete6.toKetW(),
        Offset((JA-JK*3+(PanjangT_2+LebarB_1)*c).toMirror(M, MV),
...
// keterangan NBA
    ...
    canvas.drawParagraph(Kete1.toKetW(),
        Offset((JA-JK*4+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa -JB+(-TinggiT_1+NBA*2*s*cc)*c));
...
// keterangan MLAB
    ...
    canvas.drawParagraph(Kete5.toKetW(),
        Offset((JA-JK*2+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB-JK*3+(-TinggiT_1-MBC*s)*c));
// keterangan MCB
...
Future PdfGambar1_U_1B() async {
  ...
  canvas.drawParagraph(KeteALP_C.toKetB(),
      Offset(
          (JA-JK+(PanjangT_1+LebarB_1)*c).toMirror(M, MV) ,
          TinggiCanvasa - JB+JK*3/2+(-TinggiT_1+hB/2)*c));
  final KeteALP_D = Para(Text:"D");
  canvas.drawParagraph(KeteALP_D.toKetB(),
      Offset(
          (JA-JK+(PanjangT_1+LebarB_1)*c).toMirror(M, MV) ,
          TinggiCanvasa - JB-JK*5/3+(-TinggiT_1)*c));
  ...
  canvas.drawParagraph(KeteALP_F.toKetB(),
      Offset(
          (JA+(PanjangT_1-PanjangT_2)*c).toMirror(M, MV) ,
          TinggiCanvasa - JB+JK*4/3+(-TinggiT_1-TinggiT_2)*c));
    //keterangan11
    final Kete = Para(Text: PanjangT_1.toStringAsFixed(0) + " cm",Lebar: PanjangT_1*c,Posisi: TextAlign.center);
    ...
    path.lineTo((JA +(PanjangT_1-Antrede_1)*c).toMirror(M, MV),
        TinggiCanvasa - JB +(-TinggiT_1)*c);
    path.lineTo((JA +(PanjangT_1+LebarB_1)*c).toMirror(M, MV),
        TinggiCanvasa - JB +(-TinggiT_1)*c);
    path.lineTo((JA +(PanjangT_1+LebarB_1)*c).toMirror(M, MV),
        TinggiCanvasa - JB +(-TinggiT_1)*c);
    path.lineTo((JA +(PanjangT_1+LebarB_1+bB/2)*c).toMirror(M, MV),
        TinggiCanvasa - JB +(-TinggiT_1)*c);
    path.lineTo((JA +(PanjangT_1+LebarB_1+bB/2)*c).toMirror(M, MV),
        TinggiCanvasa - JB +(-TinggiT_1+hB)*c);
    path.lineTo((JA +(PanjangT_1+LebarB_1-bB/2)*c).toMirror(M, MV),
    ...
    canvas.drawLine(
        Offset((JA+(PanjangT_1+LebarB_1-bB/2)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1+Optrede_1)*c),
        Offset((JA+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1+Optrede_1)*c), Line1);
    canvas.drawLine(
        Offset((JA+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1+Optrede_1)*c),
        Offset((JA+Antrede_1*c).toMirror(M, MV),
            TinggiCanvasa - JB), Line1);
    //tangga atas
    var path1 = Path();
    path1.moveTo((JA+(PanjangT_1)*c).toMirror(M, MV), TinggiCanvasa - JB-(TinggiT_1)*c);
    for (var i = 0; i <= OptredeNT_2-1; i++) {
    ...
    //keterangan12
    final Kete12 = Para(Text: TinggiT_1.toStringAsFixed(0) + " cm",Lebar: TinggiT_1*c,Posisi: TextAlign.center);
    canvas.drawParagraph(Kete12.toKetB(),
        Offset( -TinggiCanvasa + JB + (0.0)*c,JA + (PanjangT_1+LebarB_1+bB/2)*c+JK,));
    //keterangan 14
    final Kete14 = Para(Text: TinggiT_2.toStringAsFixed(0) + " cm",Lebar: TinggiT_2*c,Posisi: TextAlign.center);
