...
class Desain_Tangga_U_1BPage extends StatefulWidget {
  final Task task;
  final Projek projek;

  Desain_Tangga_U_1BPage({this.task,this.projek});

  @override
  _Desain_Tangga_U_1BPageState createState() => _Desain_Tangga_U_1BPageState();
}

class _Desain_Tangga_U_1BPageState extends State<Desain_Tangga_U_1BPage> {
//ceking
  void Work() {
    ...
    controllerPanjangB.text = "${(350.0).toSatuan(_satuan)}";
    controllerLebarB.text = "${(110.0).toSatuan(_satuan)}";
              ...
              children: <Widget>[
                ...
                Visibility(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('Tangga Atas'),
                      buildContainerTextFiel('Panjang Tangga Atas',  _satuan, controllerPanjangT2,LLayar),
                      buildContainerTextFiel('Tinggi Tangga Atas',  _satuan, controllerTinggiT2,LLayar),
                      buildContainerTextFiel('optrede Atas',  _satuan, controllerOptrede2,LLayar),
                      buildContainerTextFiel('Tebal Pelat Atas',  _satuan, controllerTebalT2,LLayar),
                      Text('Tangga Bawah'),
                ...
                Text('Bordes'),
                buildContainerTextFiel('Panjang Bordes',  _satuan, controllerPanjangB,LLayar),
                buildContainerTextFiel('Lebar Bordes',  _satuan, controllerLebarB,LLayar),
