...
class Material_Tangga_U_1BPage extends StatefulWidget {

  final Projek projek;
  final Task task;
  Material_Tangga_U_1BPage({this.projek,this.task});

  @override
  State<Material_Tangga_U_1BPage> createState() => _Material_Tangga_U_1BPageState();
}

class _Material_Tangga_U_1BPageState extends State<Material_Tangga_U_1BPage> {
                      ...
                      child: Container(
                        ...
                        child: Column(
                            ...
                            children: <Widget>[
                              ...
                              BuildPerancanganMaterial(
                                  "Tumpu AB",
                                  "D$Dtul_11-$Stul_11", Syarat_11=='M'?true:false,LLayar),
                              BuildPerancanganMaterial(
                                  "Tumpu BA",
                                  "D$Dtul_12-$Stul_12",Syarat_12=='M'?true:false,LLayar),
                              BuildPerancanganMaterial(
                                  "Lapang AB",
