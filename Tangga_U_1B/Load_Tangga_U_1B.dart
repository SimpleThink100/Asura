...
class Load_Tangga_U_1BPage extends StatefulWidget {

  final Projek projek;
  final Task task;
  Load_Tangga_U_1BPage({this.projek,this.task});

  @override
  State<Load_Tangga_U_1BPage> createState() => _Load_Tangga_U_1BPageState();
}

class _Load_Tangga_U_1BPageState extends State<Load_Tangga_U_1BPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Container(
          ...
          child: ListView(
            children: <Widget>[
              buildContainerTextFieldLoad("Beton", 'kN/m2', controllerBeton),
              buildContainerTextFieldLoad("Keramik", 'kN/m2', controllerKeramik),
              buildContainerTextFieldLoad("Spesi", 'kN/m2', controllerSpesi),
              buildContainerTextFieldLoad("Handralling", 'kN/m2', controllerHandralling),
