...
class Load_Tangga_LPage extends StatefulWidget {

  final Projek projek;
  final Task task;
  Load_Tangga_LPage({this.projek,this.task});

  @override
  State<Load_Tangga_LPage> createState() => _Load_Tangga_LPageState();
}

class _Load_Tangga_LPageState extends State<Load_Tangga_LPage> {
