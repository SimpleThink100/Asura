...
class OutputD_Tangga_LPage extends StatefulWidget {

  final Projek projek;
  final Task task;
  OutputD_Tangga_LPage({this.projek,this.task});

  @override
  State<OutputD_Tangga_LPage> createState() => _OutputD_Tangga_LPageState();
}

class _OutputD_Tangga_LPageState extends State<OutputD_Tangga_LPage> {
