...
//keterangan beban FHIJ
    ...
    canvas.drawParagraph(Kete16.toKetW(),
        Offset((JA+JK+(PanjangT_1+PanjangB_2)*c).toMirror(M, MV),TinggiCanvasa-JB2*1.5-JK*2+(-TinggiT_1)*c));
//keterangan beban FVIJ
    final Kete17 = Para(Text:FVbJI.toStringAsFixed(1) + " kN",);
    canvas.drawParagraph(Kete17.toKetW(),
        Offset((JA+JK+(PanjangT_1+PanjangB_2)*c).toMirror(M, MV),TinggiCanvasa-JB2+JK*3+(-TinggiT_1)*c));
  }
...
//tangga //HI
    ...
    canvas.drawLine(
        Offset((JA+(0.0)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(0.0)*c),
        Offset((JA+(NHI*s*sina_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(NHI*cosa_1*s)*c),
        Line9);
    canvas.drawLine(
        Offset((JA+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1)*c),
        Offset((JA+(PanjangT_1-NIH*s*sina_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1-NIH*s*cosa_1)*c),
        Line9);
    canvas.drawLine(
        Offset((JA+(NHI*s*sina_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(NHI*cosa_1*s)*c),
...
// keterangan NIH
    ...
    canvas.drawParagraph(Kete1.toKetW(),
        Offset((JA-JK*4+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa -JB-JK+(-TinggiT_1+NBA*s*cc)*c));
    ...
    canvas.drawLine(
        Offset((JA+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1)*c),
        Offset((JA+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1-NIJ*s)*c),
        Line9);
    canvas.drawLine(
        Offset((JA+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1-NIJ*s)*c),
        Offset((JA+(PanjangT_1+PanjangB_2)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1+NJI*s)*c),
        Line9);
    canvas.drawLine(
        Offset((JA+(PanjangT_1+PanjangB_2)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1+NJI*s)*c),
    ...
    canvas.drawParagraph(Kete5.toKetW(),
        Offset((JA-JK*4+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+JK+(-TinggiT_1-NIJ*s)*c));
// keterangan NJI
...
//tangga HI
    ...
    canvas.drawLine(
        Offset((JA+(0.0)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(0.0)*c),
        Offset((JA+(-SHI*s*sina_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-SHI*cosa_1*s)*c),
        Line9);
    canvas.drawLine(
        Offset((JA+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1)*c),
        Offset((JA+(PanjangT_1+SIH*s*sina_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1+SIH*s*cosa_1)*c),
        Line9);
    canvas.drawLine(
        Offset((JA+(-SHI*s*sina_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-SHI*cosa_1*s)*c),
...
// keterangan SIH
    ...
    canvas.drawParagraph(Kete1.toKetW(),
        Offset((JA-JK*6+(PanjangT_1+SIH*4*cs)*c).toMirror(M, MV),
            TinggiCanvasa - JB+JK+(-TinggiT_1+SIH*4*cc)*c));
    ...
    canvas.drawLine(
        Offset((JA+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1)*c),
        Offset((JA+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1+SIJ*s)*c),
        Line9);
    canvas.drawLine(
        Offset((JA+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1+SIJ*s)*c),
        Offset((JA+(PanjangT_1+PanjangB_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1-SJI*s)*c),
        Line9);
    canvas.drawLine(
        Offset((JA+(PanjangT_1+PanjangB_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1-SJI*s)*c),
    ...
    canvas.drawParagraph(Kete5.toKetW(),
        Offset((JA-JK*7+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB-JK*2+(-TinggiT_1+SIJ*s)*c));
// keterangan NJI
    final Kete6 = Para(Text:(-SJI).toStringAsFixed(1) + " kN",font: font);
    canvas.drawParagraph(Kete6.toKetW(),
        Offset((JA-JK*3+(PanjangT_1+PanjangB_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB-JK*2+(-TinggiT_1-SJI*s)*c));
...
//tangga HI
    ...
    canvas.drawLine(
        Offset((JA+(0.0)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(0.0)*c),
        Offset((JA+(-MHI*s*sina_1)*c).toMirror(M, MV),//cs
            TinggiCanvasa - JB+(-MHI*cosa_1*s)*c),//cc
        Line9);
    canvas.drawLine(
        Offset((JA+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1)*c),
        Offset((JA+(PanjangT_1+MIH*s*sina_1)*c).toMirror(M, MV),//cs
            TinggiCanvasa - JB+(-TinggiT_1+MIH*cosa_1*s)*c),//cc
        Line9);

    var arc = Path();
    arc.moveTo(
      //kiri
        (JA+(-MHI*s*sina_1)*c).toMirror(M, MV),
        TinggiCanvasa - JB+(-MHI*cosa_1*s)*c);
    arc.quadraticBezierTo(
      //tengah
        (JA+(JHI*100*cosa_1-(MLHI-MHI)*s*sina_1)*c).toMirror(M, MV),
        TinggiCanvasa - JB+(-JHI*100*sina_1-(MLHI-MHI)*s*cosa_1)*c,
        //kanan
        (JA+(PanjangT_1+MIH*s*sina_1)*c).toMirror(M, MV),
        TinggiCanvasa - JB+(-TinggiT_1+MIH*s*cosa_1)*c);
...
// keterangan MBA
    ...
    canvas.drawParagraph(Kete1.toKetW(),
        Offset((JA-JK*7+(PanjangT_1+MIH*4*cs)*c).toMirror(M, MV),
            TinggiCanvasa - JB-JK*3+(-TinggiT_1)*c));
// keterangan MLAB
    final Kete2 = Para(Text:(-MLHI).toStringAsFixed(1) + " kNm",font: font);
    canvas.drawParagraph(Kete2.toKetW(),
        Offset( (JA+(JHI*100*cosa_1-(MLHI-MHI)*2*sina_1)*c).toMirror(M, MV),
          TinggiCanvasa - JB+(-JHI*100*sina_1-(MLHI-MHI)*2*cosa_1)*c,));
    ...
    canvas.drawLine(
        Offset((JA+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1)*c),
        Offset((JA+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1-MIJ*s)*c),
        Line9);
    canvas.drawLine(
        Offset((JA+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1-MIJ*s)*c),
        Offset((JA+(PanjangT_1+PanjangB_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1+MJI*s)*c),
        Line9);
    canvas.drawLine(
        Offset((JA+(PanjangT_1+PanjangB_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB+(-TinggiT_1+MJI*s)*c),
    ...
    canvas.drawParagraph(Kete5.toKetW(),
        Offset((JA-JK*3+(PanjangT_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB-JK*4+(-TinggiT_1-MIJ*s)*c));
// keterangan MCB
    final Kete6 = Para(Text:(-MJI).toStringAsFixed(1) + " kNm",font: font);
    canvas.drawParagraph(Kete6.toKetW(),
        Offset((JA-JK*3+(PanjangT_1+PanjangB_1)*c).toMirror(M, MV),
            TinggiCanvasa - JB-JK*2+(-TinggiT_1+MJI*s)*c));
