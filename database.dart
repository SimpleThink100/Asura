...
class TaskH{
  ...
  String coltebalT1 = 'tebalT1';
  String coltebalT2 = 'tebalT2';
  String coltebalT3 = 'tebalT3';
  String coltebalB = 'tebalB';

  String colbeton = 'beton';
  String colkeramik = 'keramik';
  String colspesi = 'spesi';
  String colhand = 'hand';
  String colhidup = 'hidup';

  String coltebalkeramik = 'tkeramik';
  String coltebalspesi = 'tspesi';
  String coltebaldinding = 'tdinding';
  String colfc = 'fc';
  String colfy = 'fy';
  String colD = 'D';
  String colS = 'S' ;
  ...
  void _createDb(Database db, int version,)async {
    await db.execute(
      'CREATE TABLE $TaskTable($colid INTEGER PRIMARY KEY AUTOINCREMENT, $coljenis TEXT, $colnama TEXT, $colketerangan TEXT, $colpanjangT1 TEXT, $coltinggiT1 TEXT, $coloptredeR1 TEXT, $colpanjangT2 TEXT, $coltinggiT2 TEXT, $coloptredeR2 TEXT, $colpanjangT3 TEXT, $coltinggiT3 TEXT, $coloptredeR3 TEXT, $collebarT TEXT, $collebarB TEXT, $colpanjangB TEXT, $coltebalT1 TEXT, $coltebalT2 TEXT, $coltebalT3 TEXT, $coltebalB TEXT, $colfc TEXT, $colfy TEXT, $colbeton TEXT, $colkeramik TEXT, $colspesi TEXT, $colhand TEXT, $colhidup TEXT, $coltebalkeramik TEXT, $coltebalspesi TEXT, $coltebaldinding TEXT, $colD TEXT, $colS TEXT, $colDs TEXT, $colfcB TEXT, $colfyB TEXT, $colDB TEXT, $colsB TEXT, $colDsB TEXT, $colbB TEXT, $colhB TEXT, $colDinding TEXT, $colsatuan TEXT, $colukutanTangga TEXT, $colpembagiA TEXT, $colpembagiO TEXT, $colvisible TEXT, $colmirror TEXT, $colteratas TEXT, $colkd TEXT, $colkl TEXT, $colkm TEXT, $colko TEXT)',
    );
  }
  ...
  Future <List<Task>> getTaskList(Projek projek,int sort) async{
    numtabel = projek.id;
   ...
   switch (sort){
     ...
     case 1:
       ...
       break;
     case 2:
       TaskList.sort((a,b)=>a.nama.compareTo(b.nama));
       break;
     case 3:
       TaskList.sort((a,b)=>b.nama.compareTo(a.nama));
       TaskList.reversed;
       break;
     case 4:
       TaskList.sort((a,b)=>a.jenis.compareTo(b.jenis));
       break;
     case 5:
       TaskList.sort((a,b)=>b.jenis.compareTo(a.jenis));
       TaskList.reversed;
       break;
   }
