...
double TinggiCanvasG_14 = 0;
double TinggiCanvasG_15 = 0;
double TinggiCanvasG_16 = 0;
double TinggiCanvasG_17 = 0;
double TinggiCanvasG_18 = 0;
double TinggiCanvasG_19 = 0;
...
extension Ex on double {
  ...
  double toSatuana(String satuan) {
    double x;
    switch (satuan) {
      case"mm":
        x =this/10;
...
//tangga I
 ...
 // double toG_I_d() => this * 1 / PanjangT_1 * 180; //gambar pdf3
  ...
  double toD_L_d() => this * 1 / (PanjangT_1 + LebarT) * 220;//gambar pdf 13
  ...
  double toM_U_1B_a() => this * 1 / (PanjangT_2 + LebarB_1) * 250; //gambar pdf 1
  double toM_U_1B_b() => this * 1 / (PanjangT_1 + LebarB_1) * 250; //gambar pdf 1

  double toG_U_1B_a() =>
      this * 1 / ([PanjangT_2, PanjangT_2].reduce(max) + LebarB_1) * 240; //gambar pdf 1
  //atas
 ...
 // double toG_U_1B_j() => this * 1 / (PanjangT_2 + LebarB_1) * 220; //gambar pdf 23
  ...
  double toT_U_2B_a() => this * 1 /
      ([PanjangT_1, PanjangT_2, PanjangT_3].reduce(max) + LebarT) * 230; //gambar 1
  double toT_U_2B_b() => this * 1 /
      ([PanjangT_1, PanjangT_2, PanjangT_3].reduce(max) + LebarT) * 230; //gambar 2
  double toM_U_2B_a() => this * 1 / (PanjangT_3 + LebarT) * 220; //gambar 1
  double toM_U_2B_b() => this * 1 / (PanjangT_2 + LebarT) * 220; //gambar 1
  double toM_U_2B_c() => this * 1 / (PanjangT_1 + LebarT) * 220; //gambar 1
  double toG_U_2B_aa() => this * 1 /
      ([PanjangT_1, PanjangT_2, PanjangT_3].reduce(max) + LebarT) * 250; //gambar pdf1
  double toG_U_2B_ab() => this * 1 /
      ([PanjangT_1, PanjangT_2, PanjangT_3].reduce(max) + LebarT) * 250; //gambar pdf11
//atas
...
//tengah
  ...
  double toG_U_2B_i() => this * 1 / (PanjangT_2 + LebarT) * 140; //gambar pdf22
...
//diameter
  double toD_U_2B_a()=> this * 1 / (PanjangT_3 + LebarB_2) * 260; //gambar pdf 24
...
void ResetValue() {
    ...
    LebarB_1 = 0.0;
    PanjangB_1 = 0.0;
    TebalPelatTanggaPilih_1=0.0;
    TebalPelatTanggaPilih_2=0.0;
    TebalPelatTanggaPilih_3=0.0;
    TebalPelatBordesPilih_1=0.0;
    TebalPelatBordesPilih_2=0.0;
    TebalPelatBordesPilih_3=0.0;
  //  fy = 0.0;
  //  hB = 0.0;
 //   bB= 0.0;
    ...
    Sudut_3 = 0;
    PanjangTanggaMiring_1 = 0;

    sina_1 = 0;
    cosa_1 = 0;

    PanjangTanggaMiring_2 = 0;
    PanjangB_2 = 0;
    LebarB_2 = 0;
    sina_2 = 0;
    cosa_2 = 0;

    PanjangTanggaMiring_3 = 0;
    PanjangB_3 = 0;
    LebarB_3 = 0;
    sina_3 = 0;
    cosa_3 = 0;

    TebalPelatTangga_1 = 0;
    TebalPelatBordes_1 = 0;
    TinggiMiringAnakTangga_1 = 0;
    TinggiMiring5AnakTangga_1 = 0;
    TinggiMiringTangga_1 = 0;

    TebalPelatTangga_2 = 0;
    TebalPelatBordes_2 = 0;
    TinggiMiringAnakTangga_2 = 0;
    TinggiMiring5AnakTangga_2 = 0;
    TinggiMiringTangga_2 = 0;

    TebalPelatTangga_3 = 0;
    TebalPelatBordes_3 = 0;
    TinggiMiringAnakTangga_3 = 0;
    TinggiMiring5AnakTangga_3 = 0;
    TinggiMiringTangga_3 = 0;

    BeratSendiriTangga_1 = 0;
    BeratKeramikTangga_1 = 0;
    BeratSpesiTangga_1 = 0;
    BeratHandrailTangga_1 = 0;
    BebanMatiTangga_1 = 0;
    BebanHidupTangga_1 = 0;
    BebanTerfaktorTangga_1 = 0;

    BeratSendiriTangga_2 = 0;
    BeratKeramikTangga_2 = 0;
    BeratSpesiTangga_2 = 0;
    BeratHandrailTangga_2 = 0;
    BebanMatiTangga_2 = 0;
    BebanHidupTangga_2 = 0;
    BebanTerfaktorTangga_2 = 0;

    BeratSendiriTangga_3 = 0;
    BeratKeramikTangga_3 = 0;
    BeratSpesiTangga_3 = 0;
    BeratHandrailTangga_3 = 0;
    BebanMatiTangga_3 = 0;
    BebanHidupTangga_3 = 0;
    BebanTerfaktorTangga_3 = 0;

    BeratSendiriBordes_1 = 0;
    BeratKeramikBordes_1 = 0;
    BeratSpesiBordes_1 = 0;
    BeratHandrailBordes_1 = 0;
    BebanMatiBordes_1 = 0;
    BebanHidupBordes_1 = 0;
    BebanTerfaktorBordes_1 = 0;

    BeratSendiriBordes_2 = 0;
    BeratKeramikBordes_2 = 0;
    BeratSpesiBordes_2 = 0;
    BeratHandrailBordes_2 = 0;
    BebanMatiBordes_2 = 0;
    BebanHidupBordes_2 = 0;
    BebanTerfaktorBordes_2 = 0;

    BeratSendiriBordes_3 = 0;
    BeratKeramikBordes_3 = 0;
    BeratSpesiBordes_3 = 0;
    BeratHandrailBordes_3 = 0;
    BebanMatiBordes_3 = 0;
    BebanHidupBordes_3 = 0;
    BebanTerfaktorBordes_3 = 0;
